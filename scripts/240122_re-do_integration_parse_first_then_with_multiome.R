...
saveRDS(hthy, file = "data/rds_objects/seurat_obj_before_QC_240122.rds")
hthy <- readRDS(file = "data/rds_objects/seurat_obj_before_QC_240122.rds")
...
saveRDS(hthy, file = "data/rds_objects/seurat_obj_after_QC_240122.rds")
hthy <- readRDS(file = "data/rds_objects/seurat_obj_after_QC_240122.rds")
...
hthy3wi <- readRDS(file = "data/rds_objects/parse_samples_integrated_240122.rds")
...
DimPlot(test1wi, reduction = "umap", group.by = "sample", split.by = "sample")
...
test1wi <- readRDS(file = "data/rds_objects/seurat_obj_integrated_240123.rds")
