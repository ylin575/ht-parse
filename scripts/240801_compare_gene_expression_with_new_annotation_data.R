...
# load data
hthy <- readRDS(file = "rawdata/from sarah 240719_fixed_annotation/meyer_raw_no_qc_for_yong_counts.rds")
# Seurat version 5 or greater uses "min.features" instead of "min.genes"
hthy <- CreateSeuratObject(hthy, min.features = 100, min.cells = 2, 
                           meta.data = cell_meta)
