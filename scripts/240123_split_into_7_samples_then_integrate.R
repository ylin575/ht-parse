...
# get the batch names from reference data set
...
saveRDS(hthy2wi, file = "data/rds_objects/integrated_by_sample_all7samples_240123.rds")



# rejoin the layers after merging, this step seems to take a few minutes
hthy2wi[["RNA"]] <- JoinLayers(hthy2wi[["RNA"]])
# after rejoining layers, size of hthy2wi is 4.7 GB
