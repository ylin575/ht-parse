...
hthy <- merge(x = ctec, y = list(ht9, ht11, ht12, ht14, 
                                        ref1, ref2, ref3,
                                        mtec, ctec.cd49f, mtec.cd49f))

saveRDS(hthy, file = "data/rds_objects/250617-all-cells-post-merge.rds")
hthy <- readRDS("data/rds_objects/250617-all-cells-post-merge.rds")
...
# Plot your data, in this example my Seurat object had 15 clusters (0-14)
